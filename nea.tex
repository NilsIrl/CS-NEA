...
will allow to have an acceptable performance. Writing an interpreter in an
interpreted language would accumulate performance overhead and result in bad
performance.
...
Statement ::= for Identifier = Expression to Expression \{Statement\}\textsuperscript{*} next Identifier\\
Statement ::= while Expression \{Statement\}\textsuperscript{*} endwhile\\
Statement ::= do \{Statement\}\textsuperscript{*} until Expression\\

\noindent
Statement ::= if Expression then \{Statement\}\textsuperscript{*} \{elseif Expression then \{Statement\}\textsuperscript{*}\}\textsuperscript{*} \{else \{Statement\}\textsuperscript{*}\}\textsuperscript{?} endif\\
Statement ::= switch Expression: \{case Expression: \{Statement\}\textsuperscript{*}\}\textsuperscript{*} \{default: \{Statment\}\textsuperscript{*}\}\textsuperscript{?} endswitch\\

\noindent
Statement ::= function Identifer(\{Identifier\{:byVal|:byRef\}\}\textsuperscript{*(,)}) \{Statement\}\textsuperscript{*} endfunction\\
Statement ::= procedure Identifer(\{Identifier\{:byVal|:byRef\}\}\textsuperscript{*(,)}) \{Statement\}\textsuperscript{*} endfunction\\
