...
what is used by Visual Studio Code, writing a syntax definition for the language
for monaco would serve Visual Studio Code users as well which means a vast
majority of the users will benefit considering Visual Studio Code is the most
popular text editor in 2022.
