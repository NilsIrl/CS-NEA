...
as well as because interpreters are less complex to implement and are more
likely to work across a variety of platforms.
...
Additionally we plan on building a playground which would execute code on the
client side using WebAssembly (wasm)\cite{wasm}, a web standard which defines a
bytecode that can be executed by browsers.
