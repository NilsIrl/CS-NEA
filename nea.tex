...
hard-coded test: variable. This test can be found in the final code listing.
To have variables we also implemented string literals and integer literals.
Whilst implementing string literals we were faced with a problem that will keep
...
\begin{figure}
	...
	\caption[Caption for LOF]{Screenshot\footnotemark{} of the initial quote parser supporting all three types of quotes}
\end{figure}
